...
class CloudinaryHandler:
    ...
    def upload_file(self, file_path: str, folder: str = "chatbot/files") -> Tuple[str, str]:
        """
        ...
        """
        try:
            # Upload file with resource_type auto-detection
    ...
    def download_file(self, cloudinary_url: str) -> str:
        """
